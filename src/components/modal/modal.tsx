  ...
  return (
    <div>
      ...
      <ResponsiveModal open={open} onClose={onCloseModal} center>
        <h1 className="font-bold text-lg">List your items</h1>
        <div className="grid max-w-7xl mx-auto my-10">
          <Formik
            initialValues={{
              category: "",
              name: "",
          ...
          >
            {({
              ...
              <Form className="grid md:grid-cols-3 justify-center p-5 gap-5 rounded bg-white">
                <div>
